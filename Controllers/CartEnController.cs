...
{
    public class CartEnController : Controller
    {
            private readonly DBCNcart _dbcn;
            private readonly ProjectContext _context;

            // 建構函數注入 DBCNcart 和 ProjectContext
            public CartEnController(DBCNcart dbcn, ProjectContext context)
            {
                _dbcn = dbcn;
                _context = context;
            }
