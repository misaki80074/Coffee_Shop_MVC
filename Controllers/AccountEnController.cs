...
namespace Coffee.Controllers
{
    public class AccountEnController : Controller
    {
        ...
        public AccountEnController(ProjectContext dbContext)
        {
            _context = dbContext;
        }
    ...
    /// 登入檢查
    /// </summary>
    public class AuthFilterEn : ActionFilterAttribute
    {
        public override void OnActionExecuting(ActionExecutingContext filterContext)
        {
            ...
            {
                //合併後改成跳轉至登入頁面
                filterContext.Result = new RedirectResult("~/AccountEn/Login");
            }
        }
    }
}
